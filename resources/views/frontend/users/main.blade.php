            ...
            <form action="{{ route('user.regist') }}" class="form-horizontal" role="form" method="POST">
                ...
                <div class="col-md-6 col-sm-6">
                    <fieldset>
                        ...
                        <div class="form-group">
                            <label for="name" class="col-lg-4 control-label">Nama Lengkap : <span
                        ...
                        <div class="form-group">
                            <label for="date_of_birth" class="col-lg-4 control-label">Tanggal Lahir : <span
                                    class="require">*</span></label>
                            <div class="col-lg-8">
                ...
                <div class="col-md-6 col-sm-6">
                    <fieldset>
                        <div class="form-group">
                            <label for="phone" class="col-lg-4 control-label">Nomor Telfon : <span
                                    class="require">*</span></label>
                            <div class="col-lg-8">
                        ...
                        <div class="form-group">
                            <label for="address" class="col-lg-4 control-label">Alamat : <span
                                    class="require">*</span></label>
                            <div class="col-lg-8">
                ...
                <div class="col-md-12 col-sm-12">
                    <fieldset>
                        <div class="form-group">
                            <label for="email" class="col-lg-2 control-label">E-mail : <span
                                    class="require">*</span></label>
                            <div class="col-lg-10">
                        ...
                        <div class="form-group">
                            <label for="password_confirmation" class="col-lg-2 control-label">Konfirmasi Password :
                ...
                <div class="col-md-12">
                    <div class="row">
                        <div class="col-lg-10 col-lg-offset-2 padding-left-0 padding-top-2">
                            <a href="{{ route('user.login') }}" class="btn btn-success btn-block"
                                style="color: white;">Sudah Punya Akun ? Klik Di-Sini Untuk Login</a>
                        </div>
                    </div>
                </div>
            </form>
